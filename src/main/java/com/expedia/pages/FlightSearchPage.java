...
public class FlightSearchPage extends TestBase{
	...
	public void selectDateOneWay(String Date) {
		...
		String text1=wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.cssSelector(".uitk-calendar.uitk-calendar-day-selection-circle>div:nth-child(1)>span")))).getText();
		...
		while(!month1.equals(text1)) {
			...
			{
				driver.findElement(By.xpath("//*[@id=\"FlightSearchForm_ONE_WAY\"]/div/div[2]/div/section/div[2]/div/div/div[2]/button")).click(); 
			}
		}
		WebElement divElement = wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//div[contains(text(),'"+day1+"')]"))));
		divElement.click();
	...
	public void selectDateRoundTrip(String Date1,String Date2) {
		...
		while(!month1.equals(text1)) {
			...
			{
				driver.findElement(By.xpath("//*[@id=\"FlightSearchForm_ROUND_TRIP\"]/div/div[2]/div/section/div[2]/div/div/div[2]/button")).click(); 
			}
		}
		WebElement divElement = wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//div[contains(text(),'"+day1+"')]"))));
		divElement.click();
		...
		String text2=wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.cssSelector(".uitk-calendar.uitk-calendar-day-selection-circle>div:nth-child(1)>span")))).getText();
		...
		WebElement divElement2 = wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//div[contains(text(),'"+day2+"')]"))));
		divElement2.click();
