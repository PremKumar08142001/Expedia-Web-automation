...
public class FlightesTest extends TestBase{

	@BeforeClass
	public void beforeClass() throws InterruptedException {
		initialization();
		//This file is for testing Flights functionality
	...
	public void oneWaySearchTest() throws InterruptedException {
		...
		FlightResultPage resultPage= oneWaysearchPage.oneWayFlight(DataConifg.ORIGIN,DataConifg.DESTINATION,DataConifg.DEPAETURE_DATE);
