...
public void the_user_enters_trip_details() throws InterruptedException {
	...
	FlightResultPage resultPage= oneWaysearchPage.roundTripFlight(DataConifg.ORIGIN,DataConifg.DESTINATION,DataConifg.DEPAETURE_DATE,DataConifg.ARRIVAL_DATE);
